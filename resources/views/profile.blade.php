...
<div class="container py-5 my-5">
    <div class="row">
        ...
        <hr class="social">
        <span class="d-inline ml-md-5 px-3"><i class="fab fa-facebook fa-3x text-white"></i></span>
    ...
    <div class="row">
       ...
       <table class="table table-list-search">
                    ...
                    <tbody>
                        ...
                        <td class="text-white">
                        <a href="{{route('book.show', ['book'=>$book])}}" class="btn btnShow">Show</a>
                        <a href="{{route('book.edit', ['book'=>$book])}}" class="btn btnEdit">Edit</a>
                        <a href="{{route('book.destroy', ['book'=>$book])}}" class="btn btnRemove">Remove</a></td>
                        </tr>
                        @endforeach
