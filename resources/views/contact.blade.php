                ...
                <div class="card-body py-5">
                    <form method="POST" action="{{ route('submit') }}">
                        ...
                        <div class="form-group row ">
                            <label for="password" class=" col-md-4 col-form-label text-md-right text-white">Name & Surname</label>
                        ...
                        <div class="form-group row ">
                            <label for="email" class=" col-md-4 col-form-label text-md-right text-white">Mobile</label>
